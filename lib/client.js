...
.rt-legend{position:absolute;right:10px;bottom:34px;display:flex;flex-wrap:wrap;gap:4px 10px;max-width:250px;padding:6px 8px;background:rgba(247,245,240,.92);border:1px solid #e3e1da;border-radius:8px;font-size:10px;color:#8a8578;backdrop-filter:blur(2px);pointer-events:none}
