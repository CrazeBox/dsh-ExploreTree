...
`;
		...
		function computeLayout(nodes, collapsed, direction) {
			...
			const walk = (node, depth) => {
				...
				const p = vertical
					? { x: mid - NODE_W / 2, y: PAD + depth * LEVEL_GAP, w: NODE_W, h: NODE_H }
					...
					jsx("div", {
						...
						children: [
							...
							jsx("div", {
								...
								children: [
									jsx("b", { children: "线型" }),
									jsxs("span", { children: [jsx(LineSample, {}), "执行/探索"] }, "ln-solid"),
									jsxs("span", { children: [jsx(LineSample, { dashed: true }), "计划"] }, "ln-dash"),
